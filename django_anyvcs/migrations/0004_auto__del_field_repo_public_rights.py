...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Repo.public_rights'
        db.delete_column('anyvcs_repo', 'public_rights')


    def backwards(self, orm):
        
        # Adding field 'Repo.public_rights'
        db.add_column('anyvcs_repo', 'public_rights', self.gf('django.db.models.fields.CharField')(default='-', max_length=2), keep_default=False)
